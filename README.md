# Dika Laksana Gusta — Portfolio

Static HTML and CSS implementation of the Personal Web Figma reference (node `7:2`). No build step or JavaScript runtime is required.

Run locally with `python3 -m http.server 4173`, then open http://localhost:4173.

- `index.html`: portfolio.
- `design-system.html`: live token and component reference.
